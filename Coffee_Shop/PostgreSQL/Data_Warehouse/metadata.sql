-- Drop FACT tables first due to dependencies
DROP TABLE IF EXISTS fact_review CASCADE;
DROP TABLE IF EXISTS fact_order_details CASCADE;
DROP TABLE IF EXISTS fact_orders CASCADE;
DROP TABLE IF EXISTS fact_gift_exchange CASCADE;

-- Drop DIMENSION tables
DROP TABLE IF EXISTS dim_employee CASCADE;
DROP TABLE IF EXISTS dim_department CASCADE;
DROP TABLE IF EXISTS dim_customers CASCADE;
DROP TABLE IF EXISTS dim_gift CASCADE;
